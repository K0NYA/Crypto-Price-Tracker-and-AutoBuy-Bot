...
def check_price_change():
    ...
    if change > 5:
        print("Price of BTC in USDT has increased by {:.2f}%".format(change))
    elif change < -5:
        print("Price of BTC in USDT has decreased by {:.2f}%".format(-change))
    else:
        print("Price of BTC in USDT has not changed more than 5%")
